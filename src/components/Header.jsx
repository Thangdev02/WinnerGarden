        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="/" className="text-white hover:text-yellow-400">Trang Chủ</a>
              <a href="/about" className="text-white hover:text-yellow-400">Về Chúng Tôi</a>
              <a href="/product" className="text-white hover:text-yellow-400">Mua Cây</a>
            </div>
